...
// CODE HERE
const postTaxPrices = prices.map((number) => {
  return number + (number * .07)
})
...
// CODE HERE
const newOrderTotals = orders.map((e) => {
  let newtTotal = e.price + (e.price * e.tax)
  return newtTotal
})

console.log(newOrderTotals)
